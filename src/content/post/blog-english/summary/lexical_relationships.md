...
description: 2025-01-01 summary
tags: [english, summary]
pinned: true
---
...
- conservation n. 节约，保护（保护的意思较少见，环保实际指节约资源）
  ...
  preserve v. 保持；维持 n. 果酱；自留地、专属领域
  ...
  perseverance n. 毅力、恒心

  reserve v. 保留、备用（未来使用） n. 储量、储备；后备军；替补运动员；备用地点；保留的仪态（举止或表达上缺乏热情或坦诚）；保留原色的区域（在纺织品或陶瓷上）
